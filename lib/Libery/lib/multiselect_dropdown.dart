...
import 'package:startinsights/Libery/lib/models/network_config.dart';
import 'package:startinsights/Libery/lib/widgets/hint_text.dart';
import 'package:startinsights/Libery/lib/widgets/selection_chip.dart';
import 'package:startinsights/Libery/lib/widgets/single_selected_item.dart';
...
class _MultiSelectDropDownState<T> extends State<MultiSelectDropDown<T>> {
  ...
  Widget _buildSelectedItems() {
    if (_selectedOptions.length > 1) {
      return Text(_selectedOptions.length.toString() + " Selected");
    } else {
      return Text(_selectedOptions[0].label);
    }
